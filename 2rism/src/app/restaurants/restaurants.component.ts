    ...
    filter() {
        ...
        if ((this.type == "") && (this.place == "")){
            for (let index = 0; index < this.Hotels_And_Restaurants.length; index++) {
                ...
                if(this.Hotels_And_Restaurants[index].role == "hotel"){
                    this.H.push(this.Hotels_And_Restaurants[index])
                }
                if(this.Hotels_And_Restaurants[index].role == "restaurant"){
                    this.R.push(this.Hotels_And_Restaurants[index])
                }
